...
namespace POS.Infraestructure.Persistences.Repositories
{
    public class CategoryRepository: GenericRepository<Category>, ICategoryRepository
    {
        ...
        //{
        //    var categoryId = await context.Categories.AsNoTracking().FirstOrDefaultAsync(c => c.Id == id);
        //    return categoryId!;
        //}
        ...
        public async Task<BaseEntityResponse<Category>> ListCategories(BaseFiltersRequest filters)
        {
            ...
            if (filters.Sort is null) filters.Sort = nameof(Category.Id);
        ...
        //{
        //    var categories = await context.Categories.Where(c => c.State.Equals((int)StateTypes.Active) && c.AuditDeleteDate == null && c.AuditDeleteUser == null).AsNoTracking().ToListAsync();
        //    return categories;
        //}
        ...
        //{
        //    var category=await context.Categories.AsNoTracking().SingleOrDefaultAsync(c=>c.Id==id);
